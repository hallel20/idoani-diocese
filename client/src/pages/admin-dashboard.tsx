        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <h1 className="font-serif font-bold text-xl text-anglican-purple-700">Admin Dashboard</h1>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage diocesan content, directory information, and community events.
          </p>
        </div>

        <Tabs defaultValue="priests" className="space-y-8">
          <TabsList className="grid w-full grid-cols-5 lg:w-auto lg:inline-grid">
            <TabsTrigger value="priests" className="flex items-center space-x-2">
              <Users className="w-4 h-4" />
              <span className="hidden sm:inline">Priests</span>
            </TabsTrigger>
            <TabsTrigger value="parishes" className="flex items-center space-x-2">
              <Church className="w-4 h-4" />
              <span className="hidden sm:inline">Parishes</span>
            </TabsTrigger>
            <TabsTrigger value="archdeaconries" className="flex items-center space-x-2">
