...
import { insertPriestSchema, type Priest, type InsertPriest, type Parish } from "@shared/schema";
...
export default function PriestManagement() {
  ...
  const form = useForm<InsertPriest>({
  ...
  const createMutation = useMutation({
    mutationFn: async (data: InsertPriest) => {
  ...
  const updateMutation = useMutation({
    mutationFn: async ({ id, data }: { id: string; data: Partial<InsertPriest> }) => {
  ...
  const onSubmit = (data: InsertPriest) => {
    if (editingPriest) {
